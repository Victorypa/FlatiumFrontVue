              ...
              <div class="row col-12 justify-content-between add-space-block align-items-center pr-0 mb-2">
                ...
                <div class="col-md-7 pr-0 pl-4">
                  <div class="form-group d-flex align-items-center create-spaces">
                    ...
                    <div class="form-group__calc col-auto form-group__parametres">-5 М<sup>2</sup></div>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-5">
                  <div class="form-group form-group--margin d-flex align-items-center">
                    <input type="text" class="form-control col-md-3" placeholder="Кол-во">
                    <input type="text" class="form-control col-md-3 form-group__parametres" placeholder="800 Р/м²">
                    <div class="form-group__calc col-md-auto form-group__parametres">800
                      Р/М<sup>2</sup></div>
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  <div class="form-group form-group--margin d-flex align-items-center">
                    <input type="text" class="form-control col-md-3" placeholder="Кол-во">
                    <input type="text" class="form-control col-md-3 form-group__parametres" placeholder="800 Р/м²">
                    <div class="form-group__calc col-md-3 form-group__parametres">800
                      Р/М<sup>2</sup></div>
                  </div>
                </div>
              </div>
                ...
                <label class="col-md-7">
                  <div class="form-check custom-control">
                    ...
                    <label class="form-check-label" for="customCheck4">
                      Наименование работы очень супер длинное название
                    </label>
                  </div>
                </label>

                <div class="col-md-5 form-group__wrapper">
                  <div class="form-group form-group--margin d-flex align-items-center">
                    <input type="text" class="form-control col-md-3" placeholder="Кол-во">
                    <input type="text" class="form-control col-md-3 form-group__parametres" placeholder="800 Р/м²">
                    <div class="form-group__calc col-md-3 form-group__parametres">800
